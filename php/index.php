		...
		<div class="col-md-auto">
			<table class="table-striped table-hover border-0 mx-auto my-3 text-center">
				...
				<tbody>
					<tr>
						<td class="p-2">1</td>
						<td class="p-2" id="nimi1">
							<a href="<?php echo $inimesed_url;?>" class="text-info">Grupp 1</a>
						</td>
						...
						<td class="p-2">
							<div class="btn-group">
								<form method="post" action=<?php echo $muudagrupp_url;?>>
									...
									<input id="formnimi1" name="nimi" type="text" hidden>
									<input id="formid1" name="struktuuri_id" type="text" hidden>
					...
					<tr>
						<td class="p-2">2</td>
						<td class="p-2" id="nimi2">
							<a href=<?php echo $inimesed_url;?> class="text-info">Grupp 2</a>
						</td>
					...
					<tr>
						<td class="p-2">3</td>
						<td class="p-2" id="nimi3">
							<a href=<?php echo $inimesed_url;?> class="text-info">Grupp 3</a>
						</td>
